        ...
        <div>
            ...
            <asp:GridView ID="testeGridView" runat="server" AutoGenerateColumns="False" AllowPaging="True" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical">
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate><%#Eval("nomeContato") %>    </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate><%#Eval("nascimentoContato") %>    </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate><%#Eval("telefoneContato") %>    </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate><%#Eval("tipoTelefoneContato") %>    </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
...
&nbsp;&nbsp;
            ...
            <br />
            <br />
            <asp:Button ID="editarButton" runat="server"  Text="Atualizar" OnClick="editarButton_Click" />
            <br /><br />
            &nbsp;
            <br />
            <br />
